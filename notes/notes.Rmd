...
These notes contain some of the things I considered when writing the JvCoords
package.  They are likely not of general interest.
...
of out functions to the speed of alternative implementations from
the standard libary.
